...
(This file is a thin runner: the helpers + the fake calendar + narration live in
_m11_story.py — same printed output, just organized.)
"""
...
# Shared constants + helpers + the fake calendar + narration live in _m11_story.py
# (a thin split: same printed output; this runner keeps the whole main() flow).
from _m11_story import (
    AVI_USER,
    BELLA_USER,
    BIZ_A,
    BIZ_B,
