  ...
  return (
    <section className="bx-hero">
      ...
      <header className="bx-brand">
        ...
        {/* Login on top, demo stacked directly BELOW it. The demo used to live
            only on /login, which the "התחברות" CTA skips (it goes straight to
            Google), so a visitor could never reach it. Real navigations, not
            fetches: /auth/demo and /auth/google each answer with 302 + cookie. */}
